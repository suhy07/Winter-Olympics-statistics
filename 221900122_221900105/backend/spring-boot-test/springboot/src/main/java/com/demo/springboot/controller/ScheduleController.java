...
//            rs.previous();
    ...
    public String helloService(@RequestParam(name = "date",required = false) String date,@RequestParam
            (name="item",required = false) String item,@RequestParam(name = "place",required = false) String place) {
        // 处理date
        String aimdate="2022-02-"+date+" 00:00:00";
        String aimdate1="2022-02-"+date+" 23:59:59";
        ScheduleData scheduleData =new ScheduleData();
